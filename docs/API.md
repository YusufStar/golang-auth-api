...
For detailed API specifications including request/response schemas and authentication requirements, see the [Swagger documentation](http://localhost:8282/swagger/index.html) when the API is running.
